      ...
      return (
        <div>
          <Col md={6} lg={6} sm={6} xs={6}>
            ...
            <p>
              {ProductList.variant} | {ProductList.packaging}
            </p>
            <h6>
              Price = {ProductList.unit_price} x {ProductList.quantity} ={" "}Rp.
    ...
    return (
      <Fragment>
        ...
        <Modal show={this.state.ReviewModal} onHide={this.ReviewModalClose}>
          ...
          <Modal.Footer>
            <Button className="site-btn" onClick={this.PostReview}>
              Post
            </Button>

            <Button className="site-btn" onClick={this.ReviewModalClose}>
              Close
            </Button>
          </Modal.Footer>
        </Modal>
