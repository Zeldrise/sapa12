...
<div class="mb-3">
 <label for="formFile" class="form-label">Product Thumbnail</label>
	 ...
	 <div class="mb-3">
	 	...
	 	<img id="showImage" src="{{ url('upload/no_image.jpeg')   }}" style="width:100px; height: 100px;" >
	...
	<textarea id="mytextarea" name="long_description">Hello, World!</textarea>
	   ...
	   <option selected="">Select SubCategory</option>
		...
		<label for="inputCollection" class="form-label">Brand</label>
		  <input type="text" name="brand" class="form-control" id="inputCollection" placeholder="Your Brand">	
	  </div>

				  <div class="mb-3">
	<label class="form-label">Product Variant</label>
	 <input type="text" name="variant" class="form-control visually-hidden" data-role="tagsinput" value="Original, Pedas, Asin">
</div>

<div class="mb-3">
	<label class="form-label">Product Packaging</label>
	 <input type="text" name="packaging" class="form-control visually-hidden" data-role="tagsinput" value="Small, Medium, Large">
</div>
