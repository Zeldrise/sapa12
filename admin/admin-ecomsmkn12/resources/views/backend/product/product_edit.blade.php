...
@foreach($details as $item)
	...
	<label class="form-label">Product Variant</label>
	 <input type="text" name="variant" class="form-control visually-hidden" data-role="tagsinput" value="{{ $item->variant }}">
</div>

<div class="mb-3">
	<label class="form-label">Product Packaging</label>
	 <input type="text" name="packaging" class="form-control visually-hidden" data-role="tagsinput" value="{{ $item->packaging }}">
</div>
@endforeach
