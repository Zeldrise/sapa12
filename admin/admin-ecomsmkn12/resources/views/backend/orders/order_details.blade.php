...
<div class="container">
  ...
  <li class="list-group-item"><strong> <span class="text-dark"> Product Variant : </span> </strong> {{ $order->variant }} </li>

  <li class="list-group-item"><strong> <span class="text-dark"> Product Packaging : </span> </strong> {{ $order->packaging }} </li>
